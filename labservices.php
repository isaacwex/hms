        ...
        <div class="wrapper wrapper-content">
                <div class="row">					
					<div class="row">					
						<div class="col-lg-12">
						<p class="pull-right">
						<h2>LAB SERVICES FOR <?php echo $ps_name; ?><h2>
					...
					<div class="col-lg-8">					
						<div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>LAB SERVICES FOR <?php echo $ps_name; ?></h5>
						</div>
                        <div class="ibox-content">
                           <div class="row">
								...
								<?php 
								$No = 0;
								$getcountyname =mysqli_query($dbconnect,"SELECT * FROM tbl_labservices WHERE labservice_pscheme='$ps_code'");
								while($gcn = mysqli_fetch_array($getcountyname)){
									...
									$labservice_pscheme = $gcn['labservice_pscheme'];
								
								?>
								 <td><?php echo $No; ?></td>
									<td><?php echo $labservice_code; ?></td>
									<td><?php echo $labservice_name; ?></td>
									<td><?php echo $labservice_cost; ?>/=</td>
