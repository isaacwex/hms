                ...
                <div class="ibox float-e-margins">
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<?php "<tr class='gradeX'/>"; ?>
							...
							<a href="pharmacy.php?dispense=<?php echo $c_id; ?>"><button type="button" class="btn-xs btn-warning" onclick="return confirm('Are you sure you want to dispense and confirm for <?php echo "$fnames $lnames"; ?>?')" >Confirm and Dispense</button></a>
