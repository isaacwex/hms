                                        ...
                                        <div class="modal-body">
											...
											<form role="form" method="post">	
												...
												<?php
													...
													if($prescription_referred=='IN-STORE'){		
															$sqlbill = "INSERT INTO tbl_billing(bill_servicename,bill_amount, bill_opno,bill_visitno,bill_paymentscheme,bill_status,bill_category,bill_servicecode,bill_openclosed,bill_patientcategory,bill_qty)
															VALUES ('$drug_name','$drug_cost','$opno','$visitno','$scheme_code','$status','$category','$drug_code','$bill_openclosed','$patientcategory','$dosage_quantity')";
