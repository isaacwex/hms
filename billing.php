...
<body>
	...
	<?php include('includes/sidebar.php');?>
		...
		<?php
			...
			$getLabPatients = mysqli_query($dbconnect, "SELECT * FROM tbl_registry r INNER JOIN tbl_billing b ON b.bill_opno=r.opno AND b.bill_visitno=r.visit_no WHERE b.bill_patientcategory='$patientcategory' GROUP BY b.bill_opno ORDER BY b.bill_id DESC LIMIT 9");
						...
						<?php "<tr class='gradeX'/>"; ?>
							...
							<td><?php 
									$getinvo = mysqli_query($dbconnect, "SELECT invoice_no FROM tbl_patientinvoices WHERE invoice_visitno='$visitno' AND invoice_opno='$opno' AND invoice_category='$patientcategory' LIMIT 1");
										...
										if($invoice_no!=null){
											?>
											<span class="badge badge-primary"><?php echo $invoice_no; ?>)</span>
											<?php
										}else{
											?>
