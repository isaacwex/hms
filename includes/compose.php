            ...
            <div class="mail-box-header">
                <div class="pull-right tooltip-demo">
                   <button type="submit" name="txtdraft" class="btn btn-sm btn-primary" title="Move to Drafts"> <i class="fa fa-pencil"></i> Draft</button>
                    <a href="messages.php?status=inbox" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Discard email"><i class="fa fa-times"></i> Discard</a>
                </div>
                <h2>
                    Compose an SMS
                </h2>
                ...
                <div class="mail-body">
                    ...
                    <form class="form-horizontal" method="post">       
						<div class="form-group">
							<?php
								...
								elseif(isset($_POST['txtdraft'])){
									if(empty($_POST['contacts'])||empty($_POST['txtMsg'])){
										echo "It's empty oooooh!";
									}
									else {
										$contact_picked = $_POST['contacts'];
										$textdrafted = $_POST['txtMsg'];
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="txtMsg" rows="5" required placeholder="Text Message Here" ></textarea>
							</div>							
						</div>
