					...
					<div class="ibox-content p-xl printed">
						<!-- Hospital Details -->
							...
							<tr style="background:#61105f">
								<br /><td colspan="4" align="center" background="#61105f"><span style="font-family:Times New Roman;font-size:12pt;font-weight:bold;color:white;">OUTPATIENT INVOICE</span><br />
								</td>
							</tr>
							...
							<tr style="border-bottom: 1px solid #000;">
								...
								<td colspan="1" style="height: 17px"><span style="font-family:Times New Roman;font-size:12pt;"></span></td>
								<td style="width: 70px; height: 17px;"><span style="font-family:Times New Roman;font-size:12pt;">O.P VISIT NO:</span></td>
								<td colspan="1" style="height: 17px"><span style="font-family:Times New Roman;font-size:12pt;"><?php echo $pgender; ?> </span></td>
							</tr>  
							<tr>
								<td>&nbsp;</td>
							...
							<table width="100%" cellspacing="2">
                                ...
                                <tr style="background:#801022">
										<td colspan="7" align="center" style="font-family: 'Times New Roman', Times, serif; font-size:13pt;font-weight:bold;color:white;width:20px;padding:5px 2px">Service Charges</td>
									</tr>
                                    <tr style="background:#61105f" id="ContentPlaceHolder1_lblBank" style="color:white;border-top:1px dotted #000; font-weight:bold;text-transform:uppercase;border-bottom:1px dotted #61105f">
										<td style="font-family: 'Times New Roman', Times, serif; font-size: 12pt" width="20px; padding: 5px;">No </td>
										
										<td colspan="3" align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt; padding: 5px;">Service Name </td>
                                    ...
                                    $lab='LABORATORY';
                                    $pham='PHARMACY';
									$get_billinfo = mysqli_query($dbconnect,"SELECT * FROM tbl_billing WHERE bill_category!='$lab' AND bill_category!='$pham' AND bill_opno='$billopno' AND bill_visitno='$billvisitno' group by bill_servicecode");
                                    $get_billinfosum = mysqli_query($dbconnect,"SELECT * FROM tbl_billing WHERE bill_category!='$lab' AND bill_category!='$pham' AND bill_opno='$billopno' AND bill_visitno='$billvisitno'");
                                    $sumpham=mysqli_num_rows($get_billinfosum);
									$No=0;
									...
									<tr>
										...
										<td colspan="3" align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;padding:5px"><?php echo ucwords($bill_servicename); ?></td>
										<td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;padding:5px"><?php echo  $sumpham;?></td>
                                    ...
                                    <tr style="background:#801022">
										<td colspan="7" align="center" style="font-family: 'Times New Roman', Times, serif; font-size:13pt;font-weight:bold;color:white;width:20px;padding:5px 2px">Lab</td>
									</tr>
                                    <tr style="background:#61105f" id="ContentPlaceHolder1_lblBank" style="color:white; border-top:1px dotted #000; font-weight:bold;text-transform:uppercase;border-bottom:1px dotted #61105f">
										<td style="font-family: 'Times New Roman', Times, serif; font-size: 12pt" width="20px; padding: 5px;">No </td>
									...
									$lab='LABORATORY';
									$get_Obillinfo = mysqli_query($dbconnect,"SELECT * FROM tbl_billing WHERE bill_category='$lab' AND bill_opno='$billopno' AND bill_visitno='$billvisitno' group by bill_servicecode");
                                    $get_Obillinfosum = mysqli_query($dbconnect,"SELECT * FROM tbl_billing WHERE bill_category='$lab' AND bill_opno='$billopno' AND bill_visitno='$billvisitno'");
                                    $sumlab=mysqli_num_rows($get_Obillinfosum);
                                    $No = 0;
									while($billO = mysqli_fetch_array($get_Obillinfo)){
										$No = $No+1;
										$billO_amount = $billO['bill_amount'];
										$billO_category = strtolower($billO['bill_category']);
										$billO_servicename = strtolower($billO['bill_servicename']);
										$billO_scheme = $billO['bill_paymentscheme'];
										$billO_datetime = $billO['bill_datetime'];
										$billO_datetime = $billO['bill_paymentscheme'];
									?>
										<tr>
										<td style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;width:20px;padding:5px 2px"><?php echo $No; ?></td>
										
										<td colspan="3" align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;padding:5px"><?php echo ucwords($billO_servicename); ?></td>
										<td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;padding:5px"><?php echo $sumlab;?></td>
										<td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;padding:5px"><?php echo ucwords($billO_amount); ?></td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;padding:5px"><?php echo number_format($billO_amount); ?></td>
									</tr>
									<?php
									}?>
                                    <tr style="background:#801022">
										<td colspan="7" align="center" style="font-family: 'Times New Roman', Times, serif; font-size:13pt;font-weight:bold;color:white;width:20px;padding:5px 2px">Medicine</td>										
									</tr>
                                    <tr style="background:#61105f" id="ContentPlaceHolder1_lblBank" style="color:white; border-top:1px dotted #000; font-weight:bold;text-transform:uppercase;border-bottom:1px dotted #61105f">
										<td style="font-family: 'Times New Roman', Times, serif; font-size: 12pt" width="20px; padding: 5px;">No </td>
                                    ...
                                    $No = 0;
                                    $pham='PHARMACY';
									$get_Obillinfo = mysqli_query($dbconnect,"SELECT * FROM tbl_billing WHERE bill_category='$pham' AND bill_opno='$billopno' AND bill_visitno='$billvisitno' group by bill_servicecode");
                                    $get_Obillinfosum = mysqli_query($dbconnect,"SELECT * FROM tbl_billing WHERE bill_category='$pham' AND bill_opno='$billopno' AND bill_visitno='$billvisitno'");
                                    $sumpham=mysqli_num_rows($get_Obillinfosum);
									while($billO = mysqli_fetch_array($get_Obillinfo)){
										$No = $No+1;
										$billO_amount = $billO['bill_amount'];
										$billO_category = strtolower($billO['bill_category']);
									...
									?>
									<tr>
										<td colspan="7" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;width:10px;text-align:right;font-weight:bolder;padding:2px 5px">TOTAL</td>
							...
							<a href="printbill.php?c_id=<?php echo $billvisitno; ?>&opno=<?php echo $billopno;?>"><button class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Print PDF Invoice</button></a> || <a href="#invoice" data-toggle="modal" title="Profile">Edit</a>		
									<?php include('modals/invoice_edit.php');?>
