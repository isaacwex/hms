                        ...
                        <div class="ibox-content">
                           <div class="row">
								...
								?>
									...
									<td>	</td>
									<td><a href="edit-drug.php?drug_id=<?php echo $drugid; ?>"><button class="btn-xs btn-primary"><i class="fa fa-pencil"></i> Edit </button></a> | <button class="btn-xs btn-danger"><i class="fa fa-trash"></i></button></td>
								</tr>
								<?php
								}
								?>
