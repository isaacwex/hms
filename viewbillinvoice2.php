							...
							<table width="100%" cellspacing="2">
								...
								<table width="100%" cellpadding="5" border="1px" id="table" style="height: 97px; margin-left:2px">
									<tr id="ContentPlaceHolder1_lblBank" style="background-color:gray; border-top-width: 1pt; border-top-color: #000000;font-weight:bold;">
										...
										<td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt; padding: 5px;">Service Category 
										</td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt; padding: 5px;">Service Name 
										</td>
									...
									<tr>
										...
										<td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;padding:5px"><?php echo $bill_category; ?></td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;padding:5px"><?php echo $bill_servicename; ?></td>
									...
									?>
									<tr>
										<td colspan="3" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt;width:10px;text-align:right;font-weight:bolder;padding:2px 5px">TOTAL</td>
