...
require_once ('tcpdf/tcpdf.php');
			...
			*/
			...
			$sqlOthers = "SELECT * FROM tbl_billing WHERE bill_opno='$billopno' AND bill_visitno='$billvisitno' AND bill_patientcategory='$invoice_category' AND bill_category NOT IN ('PHARMACY','LABORATORY','INPATIENT','CONSULTATION') GROUP BY bill_servicecode";
