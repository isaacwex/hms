...
$updateMsg = mysqli_query($dbconnect,"UPDATE tbl_messages SET read_status='1' WHERE message_id='$msg_id'");
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Reply Message - <?php echo "$campaigner_name - $smart_name"; ?></title>
                    ...
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            ...
                            <ul class="folder-list m-b-md" style="padding: 0">
                                ...
                                <li><a href="messages.php?status=important"> <i class="fa fa-certificate"></i> Important <span class="label label-warning pull-right"><?php echo $c2 ?></span> </a></a></li>
                         
                                <li><a href="messages.php?status=trash"> <i class="fa fa-trash-o"></i> Trash <span class="label label-warning pull-right"><?php echo $c4; ?></span> </a></a></li>
                            </ul>
                            <h5>Categories</h5>
