										...
										/*	$labrequest_labservicecode = $lrarray['labrequest_labservicecode'];
											...
											$labrequest_opno = $lrarray['labrequest_opno'];*/
														...
														$testconclusion = $dbconnect->real_escape_string($_POST['testconclusion']);
															...
															$updateStatus = "UPDATE tbl_labrequests SET labrequest_componentsample=?,labrequest_results=?,labrequest_conclusion=? WHERE labrequest_opno='$labrequest_opno' AND visitno='$labrequest_visitno' AND labrequest_labservicecode='$labrequest_labservicecode'";
