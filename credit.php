...
<head>
	...
	<title>Credit Management - <?php echo $smart_name; ?></title>
            ...
            <div class="col-lg-6">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Credit Loading and History</h5>
                    </div>
									...
									if($countNo >= 1){
											...
											if($stmt = $dbconnect->prepare("INSERT INTO tbl_categories (cat_no, category_name, cat_description) VALUES (?,?,?)")){
												...
												<div class="col-sm-12">
														...
														<div class="form-group">
															<input type="submit" name="newgroup" class="btn btn-lg btn-primary" value="Validate Payment" />
														</div>
												</div>
													</form>
