						...
						<!-- Hospital Details -->
							...
							<table width="100%" cellspacing="2">
								...
								<table width="100%" cellpadding="5" border="1px" id="table" style="height: 97px; margin-left:2px">
									...
									<tr style="font-family: 'Times New Roman', Times, serif; font-size: 10px; border-top-style: solid; border-top-width: 1pt; border-top-color: #000000"><td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12px; border-top-style: solid; border-top-width: 1px; border-top-color: #ff0000"> Name: _________________________________________ </td>
									<td align="centre" style="font-family: 'Times New Roman', Times, serif; font-size: 13px; border-top-style: solid; border-top-width: 1px; border-top-color: #ff0000"> Signature ______________________________________</td><br>
									</tr>
