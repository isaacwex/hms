							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">									
									...
									<?php
															...
															?>
														<a href="registry.php?closevisitid=<?php echo $c_id; ?>&op=<?php echo $opno;?>&vis=<?php echo $visitno;?>><button type="button" class="btn-xs btn-white" onclick="return confirm('Are you sure you want to generate the visit number for the patient? Generating a new visit number will start a new treatment process for the patient?')" > Close Visit</button></a>
