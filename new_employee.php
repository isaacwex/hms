												...
												<div class="col-lg-12">
												  ...
												  <div class="col-lg-6">
													<div class="form-group mg-b-10-force">
													  ...
													  <select class="form-control select2" name="bank" data-placeholder="Choose Bank" required>
														<option value="">Choose Bank</option>
														<option value="001">Cooperative Bank</option>
														<option value="002">Equity Bank</option>
														<option value="003">National Bank</option>
													  </select>
													</div>
												  </div><!-- col-4 --> 
