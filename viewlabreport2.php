...
<head>
   ...
   <title>View Lab Report - <?php echo $smart_name; ?></title>
                ...
                <div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="ibox-content p-xl printed">
						<!-- Hospital Details -->
							...
							<tr>
								<br /><td colspan="4" align="center"><span style="font-family:Times New Roman;font-size:14pt;font-weight:bold;color:red;">PATIENT LABORATORY REPORT </span><br />
								<hr>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="4" align="center"><span id="ContentPlaceHolder1_lblBank" style="font-family:Times New Roman;font-size:12pt;font-weight:bold;">LABORATORY SERVICE DETAILS</span><br /></td>
							</tr> 
							...
							<table width="100%" cellspacing="2">
								...
								<table width="100%" cellpadding="5" border="1px" id="table" style="height: 97px; margin-left:2px">
									<tr id="ContentPlaceHolder1_lblBank"style="background-color:gray; border-top-width: 1pt; border-top-color: #000000;font-weight:bold">
										...
										<td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt">Test
										</td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt">Component 
										</td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt">Status</td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt">Results 
										</td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt">Conclusion</td>
									</tr>
									<?php
									$No = 0;
									$get_billinfo = mysqli_query($dbconnect,"SELECT * FROM tbl_labrequests l INNER JOIN tbl_labservices v ON l.labrequest_labservicecode=v.labservice_code WHERE labrequest_opno='$billopno' AND labrequest_visitno='$billvisitno'");
									while($bill = mysqli_fetch_array($get_billinfo)){
										$No = $No+1;
										$labrequest_labservicecode = $bill['labrequest_labservicecode'];
										$labservice_name = $bill['labservice_name'];
									...
									?>
									<tr>
										<td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt"><?php echo $labservice_name; ?></td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt"><?php echo $labrequest_componentsample; ?></td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt"><?php echo $labrequest_status; ?></td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt"><?php echo $labrequest_results; ?></td>
										<td align="right" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt"><?php echo $labrequest_conclusion; ?></td>
									</tr>
									<?php
									}
									...
									<tr style="font-family: 'Times New Roman', Times, serif; font-size: 10px; border-top-style: solid; border-top-width: 1pt; border-top-color: #000000"><td align="left" style="font-family: 'Times New Roman', Times, serif; font-size: 12px; border-top-style: solid; border-top-width: 1px; border-top-color: #ff0000">Pathologist Name: _______________ </td>
									<td align="centre" style="font-family: 'Times New Roman', Times, serif; font-size: 12px; border-top-style: solid; border-top-width: 1px; border-top-color: #ff0000">Pathologist Signature _______________</td>
									</tr>
