    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div class="designed">
            ...
            <form class="m-t" role="form" name="login" action="" method="post">
                ...
                <div class="form-group">
                    <input type="text" name="sc_email" autocomplete="off" class="form-control" placeholder="ID Number" required="">
                </div>
                <div class="form-group">
                    <input type="password" name="sc_pass" autocomplete="off" class="form-control" placeholder="Password" required="">
                </div>
