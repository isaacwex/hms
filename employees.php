               ...
               <?php if(isset($res)){
				...
				<div class="col-lg-12">
					<div class="form-group">
					  <h3 class="tx-gray-800 tx-uppercase tx-semibold tx-15 mg-b-25">LIST OF PROFILES</h3>
					</div>
				</div><!-- col-4 -->
				...
				<table class="table  ">
				  ...
				  <tbody>
					  ...
					  if($user_l=='ADMINISTRATOR'){
							...
							$getEmployees = mysqli_query($dbconnect,"SELECT * FROM tbl_employees WHERE emp_idno='$loggedemp_idno'");
					  }
								$No=0;
								while($ge = mysqli_fetch_array($getEmployees)){
									...
									$empkra = $ge['emp_kra'];
										...
										";?>
										<td>
								  <a href="employeefullprofile.php?empid=<?php echo $idno;?>">Open</a>|
								  <?php if($user_l=='ADMINISTRATOR'){ ?>
								  <a href="#employees<?php echo $idno;?>" data-toggle="modal" title="Profile">More</a>		
									<?php 
									include('modals/employees_info.php');
								   }
									?>
								   </td>
											</tr>
