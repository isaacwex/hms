                            ...
                            <div class="ibox float-e-margins">
                                <form action="invoiceprocesor.php" method="post">
                                    <div class="col-md-4">
										...
										<div class="form-group" style="display:block;">
											...
											<div class="input-group">
												<select data-placeholder="Choose drug..." name="drug" class="form-control chosen-select" tabindex="4">
									...
									<div class="form-group" style="display:block;">
                                        ...
                                        <input type="text" name="supplier" placeholder="Enter name of your Supplier" class="form-control">  <?php }else{ ?><input type="text" name="supplier" value="<?php $_SESSION['supplier'];?>" disabled placeholder="Enter name of your Supplier" class="form-control"> <?php } ?>
                                        </div>
                                    </div>
